            ...
            <div class="form-group">
              ...
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row">
                	...
                	<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Asset Name</th>
				...
				<!-- loop over and print our customers -->
      			<c:forEach var="tempAsset" items="${listAssets}">
       			...
       			<c:url var="updateLink" value="/updateasset/${tempAsset.assetid}">
<%--         		<c:param name="userId" value="${tempMember.id}" /> --%>
       			...
       			<c:url var="deleteLink" value="/deleteasset/${tempAsset.assetid}">
<%--         		<c:param name="userId" value="${tempMember.id}" /> --%>
       			</c:url>
       			<tr>
