...
<html lang="en">
	<head>
		...
		<!-- Bootstrap -->
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/resources/template/css/bootstrap.min.css"/>

		<!-- Owl Carousel -->
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/resources/template/css/owl.carousel.css" />
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/resources/template/css/owl.theme.default.css" />

		<!-- Magnific Popup -->
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/resources/template/css/magnific-popup.css" />

		<!-- Font Awesome Icon -->
		<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/template/css/font-awesome.min.css">

		<!-- Custom stlylesheet -->
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/resources/template/css/style.css"/>
	...
	<body>
		...
		<header id="header">
			...
			<div id="top-navbar" class="navbar">
				<div class="container">
					<a class="logo" href="index.html"><img src="${pageContext.request.contextPath }/resources/template/img/muf.png" alt="logo" width="76px" height="40px" style="margin-top: 13px;"></a>
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="#" class="text-link"><i class="fa fa-envelope"></i><span>muf@support.com</span></a></li>
					</ul>
				</div>
			</div>
			<!-- /Top Header -->
		...
		<div id="home" class="banner-area">
			...
			<video autoplay muted loop id="myVideo" width="100%;" >
				<source src="${pageContext.request.contextPath }/resources/template/video/mubc.mp4" type="video/mp4">
			</video>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1" style="margin-left: 10%;">
							<h1>Let We Handle Your Financial</h1>
							<p class="lead" style="color: black;">Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum.</p>
							<a href="${pageContext.request.contextPath }/dashboard" class=" btn secondary-button">Load more</a>
						</div>
						<!-- /home content -->
		...
		<div id="about">
			...
			<div class="section md-section">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="about">
								<img src="${pageContext.request.contextPath }/resources/template/img/about1.jpg" alt="">
						...
						<div class="col-md-4">
							<div class="about">
								<img src="${pageContext.request.contextPath }/resources/template/img/about2.jpg" alt="">
						...
						<div class="col-md-4">
							<div class="about">
								<img src="${pageContext.request.contextPath }/resources/template/img/about3.jpg" alt="">
			...
			<div class="section md-section bg-grey">
				...
				<div class="bg-img bg-half overlay" style="background-image:url('${pageContext.request.contextPath }/resources/template/img/about4.jpg')"></div>
				<!-- /Half Background Image -->
					...
					<div id="portfolio-slider" class="owl-carousel owl-theme">
						...
						<div class="portfolio">
							<div class="portfolio-img">
								...
								<img src="${pageContext.request.contextPath }/resources/template/img/project1.jpg" alt="">
							</div>
						...
						<div class="portfolio">
							<div class="portfolio-img">
								...
								<img src="${pageContext.request.contextPath }/resources/template/img/project2.jpg" alt="">
							</div>
							<div class="portfolio-content">
								<h3>Project Title</h3>
								<span>Category</span>
						...
						<div class="portfolio">
							<div class="portfolio-img">
								...
								<img src="${pageContext.request.contextPath }/resources/template/img/project3.jpg" alt="">
							</div>
							<div class="portfolio-content">
								<h3>Project Title</h3>
								<span>Category</span>
						...
						<div class="portfolio">
							<div class="portfolio-img">
								...
								<img src="${pageContext.request.contextPath }/resources/template/img/project4.jpg" alt="">
							</div>
							<div class="portfolio-content">
								<h3>Project Title</h3>
								<span>Category</span>
		...
		<div class="section md-section bg-grey">
			...
			<!-- Half Background Image -->
			<div class="bg-img bg-half bg-right overlay" style="background-image:url('${pageContext.request.contextPath }/resources/template/img/about5.jpg')"></div>
			<!-- Half Background Image -->
		...
		<div id="clients" class="section">
			...
			<!-- Half Background Image -->
			<div class="bg-img overlay" style="background-image:url('${pageContext.request.contextPath }/resources/template/img/background2.jpg')"></div>
			<!-- /Half Background Image -->
					...
					<div class="row">
						...
						<div id="partners-slider" class="owl-carousel owl-theme">
							...
							<a href="#" class="partner">
								<img src="${pageContext.request.contextPath }/resources/template/img/partner.jpg" alt="">
							</a>
							<!-- /partner -->
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="blog">
							<div class="blog-img">
								<img src="${pageContext.request.contextPath }/resources/template/img/blog1.jpg" alt="">
							</div>
							<ul class="blog-meta">
					...
					<div class="col-md-4">
						<div class="blog">
							<div class="blog-img">
								<img src="${pageContext.request.contextPath }/resources/template/img/blog2.jpg" alt="">
							</div>
							<ul class="blog-meta">
								<li>10 November 2017 ,</li>
								<li>By John Doe</li>
					...
					<div class="col-md-4">
						<div class="blog">
							<div class="blog-img">
								<img src="${pageContext.request.contextPath }/resources/template/img/blog3.jpg" alt="">
							</div>
							<ul class="blog-meta">
								<li>10 November 2017 ,</li>
								<li>By John Doe</li>
						...
						<div class="col-md-4 footer-widget">
							<div class="footer-logo">
								<a class="logo" href="index.html">
									<img
								src="${pageContext.request.contextPath }/resources/template/img/logo-alt.png"
								alt="logo">
							</a>
		...
		<!-- jQuery Plugins -->
		<script type="text/javascript" src="${pageContext.request.contextPath }/resources/template/js//jquery.min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath }/resources/template/js//bootstrap.min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath }/resources/template/js//owl.carousel.min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath }/resources/template/js//jquery.magnific-popup.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath }/resources/template/js//main.js"></script>
