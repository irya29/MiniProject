...
<div class="wrapper">
  ...
  <header class="main-header" style="background-color: #000; !important">
    <!-- Logo -->
    <a href="${pageContext.request.contextPath }/" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
       <img  src="${pageContext.request.contextPath }/resources/template/img/muf.png" alt="logo" width="90px" height="50px">
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Irya Virgo</span>
            </a>
  ...
  <aside class="main-sidebar" style="background-color: #222D32 !important; color:#fff !important;">
...
<%--          <li><a href="${pageContext.request.contextPath }/admin/master/user"><i class="fa fa-circle-o"></i> User</a></li> --%>
        ...
        <li style="color:#fff !important;"><a href="${pageContext.request.contextPath }/dashboard"><i class="fa fa-home " style="color:#fff !important;"></i> Home</a></li>
        <li style="color:#fff !important;"><a href="${pageContext.request.contextPath }/member"><i class="fa fa-user-o " style="color:#fff !important;"></i> Member</a></li>
        <li style="color:#fff !important;"><a href="${pageContext.request.contextPath }/asset"><i class="fa fa-briefcase " style="color:#fff !important;"></i> Asset</a></li>
